...
def super_pipeline(
    ...
    # p2_pipeline_input_parent_path: str = "__input_parebt_path__",
    # p2_pipeline_output_parent_path: str = "__output_parent_path__",
    # p2_pipeline_parent_path_suffix: str = "__parent_path_suffix__",
    ...
    # p2_pipeline_data_s3_access_secret: str = "__s3_access_secret__",
