...
mc cp --recursive ${REPOROOT}/transforms/code/inputcode2parquet/ray/test-data/input/data-processing-lib.zip kfp/test/inputcode2parquet/input
mc cp --recursive ${REPOROOT}/transforms/code/inputcode2parquet/ray/test-data/languages/ kfp/test/inputcode2parquet/languages
