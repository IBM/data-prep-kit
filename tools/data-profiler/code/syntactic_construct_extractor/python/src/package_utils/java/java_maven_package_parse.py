...
def extract_library_names(json_filepath, output_filepath):
    try:
        ...
        library_names = [item["library_name"].replace(":", ".") for item in data if "library_name" in item]
...
# Example usage
json_filepath = "library_maven.json"
output_filepath = "java_maven_packages.txt"
