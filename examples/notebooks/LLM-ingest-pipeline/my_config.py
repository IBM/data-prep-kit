...
MY_CONFIG.DB_URI_hq = './rag_html.db'  # For embedded instance
MY_CONFIG.COLLECTION_NAME_hq = 'high_quality'
...
## LLM Model
#MY_CONFIG.LLM_MODEL = "meta/meta-llama-3-8b-instruct:855g9wxd7hrgp0cf7tsv1ewzgc"
# MY_CONFIG.LLM_MODEL = "meta/meta-llama-3-70b-instruct"
MY_CONFIG.LLM_MODEL = "ibm-granite/granite-3.3-8b-instruct:t96wgpwzn9rm80cp79q8cxprm8"
