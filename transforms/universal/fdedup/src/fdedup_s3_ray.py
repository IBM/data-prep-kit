...
from fdedup_transform import FdedupTableTransformConfiguration, FdedupRuntime

# create launcher
launcher = RayTransformLauncher(FdedupTableTransformConfiguration(), FdedupRuntime)
# create parameters
s3_cred = {
