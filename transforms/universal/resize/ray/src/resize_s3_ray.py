...
from data_processing_ibm.utils import DPTIConfig
from resize_transform import ResizeRayTransformConfiguration


print(os.environ)
# create launcher
launcher = TransformLauncherIBM(transform_runtime_config=ResizeRayTransformConfiguration())
# create parameters
s3_cred = {
    "access_key": DPTIConfig.S3_ACCESS_KEY,
    "secret_key": DPTIConfig.S3_SECRET_KEY,
