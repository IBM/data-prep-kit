...
from pdf2md_transform import Pdf2MdTransformConfiguration, Pdf2MdTransform


logger = get_logger(__name__)

class Pdf2MdRayTransform(Pdf2MdTransform):
...
class Pdf2MdRayTransformConfiguration(RayTransformRuntimeConfiguration):
    """
    Implements the RayTransformConfiguration for PDF2MD as required by the RayTransformLauncher.
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__(transform_config=Pdf2MdTransformConfiguration(transform_class=Pdf2MdRayTransform))
