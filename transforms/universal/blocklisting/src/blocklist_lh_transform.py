...
class BlockListLHTransform(AbstractTableTransform):
    """
...
class BlockListLHTransformConfiguration(DefaultTableTransformConfiguration):
    ...
    def __init__(self):
        super().__init__(name="BlockListing", transform_class=BlockListLHTransform, runtime_class=BlockListLHRuntime)
        self.params = {}
...
class BlockListLHRuntime(DefaultTableTransformRuntime):
    """
    ...
    def get_transform_config(
        ...
        if isinstance(data_access, DataAccessLakeHouse):
            domain_list = get_domain_list(url, None)
        else:
