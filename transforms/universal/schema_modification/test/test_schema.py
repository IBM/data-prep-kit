...
from schema_transform import SchemaTransform
...
class TestSchemaTransform(AbstractTransformTest):
    """
    ...
    def get_test_transform_fixtures(self) -> list[Tuple]:
        fixtures = [
            ...
            # (SchemaTransform({"sleep": 0}), [table], [expected_table], expected_metadata_list),
            # (SchemaTransform({"sleep": 0}), [table], [expected_table], expected_metadata_list),
        ]
        return fixtures
