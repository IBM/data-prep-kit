...
class TestSyntacticConceptExtractorTransformRay(AbstractTransformLauncherTest):
    """
    ...
    def get_test_transform_fixtures(self) -> list[tuple]:
        ...
        fixtures = []
        launcher = RayTransformLauncher(SyntacticConceptExtractorRayTransformConfiguration())
        ...
        transform_config = {
            "SyntacticConceptExtractor_contents": "Contents",
            "SyntacticConceptExtractor_language": "Language",
        }
        fixtures.append(
            (
                launcher,
