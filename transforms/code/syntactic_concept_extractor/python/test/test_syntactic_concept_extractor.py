...
from syntactic_concept_extractor_transform import SyntacticConceptExtractorTransform, SyntacticConceptExtractorTransformConfiguration
...
class TestSyntacticConceptExtractorTransform(AbstractTableTransformTest):
    """
    ...
    def get_test_transform_fixtures(self) -> list[tuple]:
        ...
        fixtures = [
            (SyntacticConceptExtractorTransform(config), input_tables, expected_tables, expected_metadata_list),
        ]
        return fixtures
