...
def compute_exec_params_func(
    ...
    return {
        ...
        "repo_lvl_sorting_enable": repo_lvl_sorting_enable,
...
@dsl.pipeline(
    ...
    description="Pipeline for repo_level_order task",
)
def repo_level_order(
    # Ray cluster
    ray_name: str = "repo_level_order-kfp-ray",  # name of Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'test/repo_level_order/input/', 'output_folder': 'test/repo_level_order/output/'}",
    ...
    repo_lvl_sorting_enable: bool = True,
    repo_lvl_sorting_algo: str = "SORT_SEMANTIC_NORMALISED",
    repo_lvl_store_type: str = "ray",
    repo_lvl_language_column: str = "programming_language",
    ...
    :param repo_lvl_sorting_enable - enable sorting
    :param repo_lvl_sorting_algo - algorithm for sorting
    :param repo_lvl_store_type - store type
    :param repo_lvl_language_column - language column name
    :return: None
    """
