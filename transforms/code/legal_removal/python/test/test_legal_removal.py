...
class TestLegalRemovalTransform(AbstractTableTransformTest):
    """
    Extends the super-class to define the test data for the tests defined there.
    The name of this class MUST begin with the word Test so that pytest recognizes it as a test class.
    """

    def create_legal_removal_test_fixture(
        self,
        column: str,
        license: str,
        copyright: str,
    ...
    ) -> tuple[LegalRemovalTransform, pa.Table, pa.Table, list[dict]]:
        cli = [
            f"--{column_cli_params}",
            column,
        ...
        ftc = LegalRemovalTransformConfiguration()
        ...
        return LegalRemovalTransform(config), [input_df], [expected_output_df], expected_metadata_list
    ...
    def get_test_transform_fixtures(self) -> list[tuple]:
        ...
        fixtures.append(
            self.create_legal_removal_test_fixture(
                column_name,
                license,
                copyright,
                input_dir,
