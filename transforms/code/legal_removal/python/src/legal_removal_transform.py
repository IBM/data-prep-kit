...
short_name = "legal_removal"
cli_prefix = short_name + "_"
LICENSE_COPYRIGHT_REMOVE_PARAMS = "legal_removal_prams"
...
class LegalRemovalTransform(AbstractTableTransform):
...
class LegalRemovalTransformConfiguration(TransformConfiguration):
    def __init__(self):
        super().__init__(name="legal_removal", transform_class=LegalRemovalTransform)
...
class LegalRemovalPythonTransformConfiguration(PythonTransformRuntimeConfiguration):
    def __init__(self):
