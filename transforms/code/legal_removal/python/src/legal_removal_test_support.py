...
from legal_removal_transform import (
    LegalRemovalPythonTransformConfiguration,
    column_cli_params,
    license_cli_params,
...
class AbstractPythonLegalRemovalTransformTest(AbstractTransformLauncherTest):
    """
    ...
    def _get_launcher(self) -> (AbstractTransformLauncher, dict):
        ...
        """
        return (PythonTransformLauncher(LegalRemovalPythonTransformConfiguration()), {})
