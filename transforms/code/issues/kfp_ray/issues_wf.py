...
task_image = "quay.io/dataprep1/data-prep-kit/issues-ray:latest"
...
def compute_exec_params_func(
    ...
    issues_events_column_name: str,
    issues_min_chars: int,
    issues_max_chars: int,
    issues_max_events: int,
    issues_max_lines: int,
) -> dict:
...
TASK_NAME: str = "issues"


@dsl.pipeline(
    name=TASK_NAME + "-ray-pipeline",
    description="Pipeline for multiple issues",
)
def issues(
    # Ray cluster
    ray_name: str = "issues-kfp-ray",  # name of Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'test/issues/input/', 'output_folder': 'test/issues/output/'}",
    ...
    # issues parameters
    issues_events_column_name: str = "events",
    issues_min_chars: int = 200,
    issues_max_chars: int = 7000,
    issues_max_events: int = 10,
    issues_max_lines: int = 80,
    ...
    :param issues_min_chars - specifies minimum characters that text of issue with only one user is required to contain
    :param issues_max_chars - specifies maximum characters that text of issue with only one user is allowed to contain
    :param issues_max_events - specifies maximum events that issue with only one user is allowed to contain
    :param issues_max_lines - specifies maximum lines that text of issue can hold. The longer text will be truncated
    :param issues_events_column_name - specifies column name to get the list of events
    :return: None
    """
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(issues, __file__.replace(".py", ".yaml"))
