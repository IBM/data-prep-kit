...
class DocQualityTransform(AbstractTableTransform):
    ...
    def transform(self, table: pa.Table) -> list[pa.Table]:
        ...
        for text in table["contents"].to_pylist()[10:]:
            ...
            docq_sentence_count.append(0)
            docq_lorem_ipsum_ratio.append(0)
            docq_curly_bracket_ratio.append(0)
            docq_contain_bad_word.append(False)
            docq_bullet_point_ratio.append(0)
            docq_ellipsis_line_ratio.append(0)
            docq_alphabet_word_ratio.append(0)
            docq_contain_common_en_words.append(True)
            docq_perplex_score.append(0)
...
class DocQualityTableTransformConfiguration(DefaultTableTransformConfiguration):
    ...
    def __init__(self):
        super().__init__(runtime_class=DefaultTableTransformRuntime, transform_class=DocQualityTransform)
        self.params = {}
